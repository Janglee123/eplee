...
EPUBJS.Reader.prototype.adjustFontSize = function(e) {
	var fontSize;
	var interval = 2;
	var PLUS = (e.keyCode == 187 || e.keyCode == 107);
	var MINUS = (e.keyCode == 189 || e.keyCode == 109);
	var ZERO = (e.keyCode ==  48);
	var MOD = (e.ctrlKey || e.metaKey );

	if(!this.rendition.themes._overrides['font-size']) {
		this.rendition.themes.fontSize("100%");
	}
	fontSize = parseInt(this.rendition.themes._overrides['font-size'].value.slice(0,-1));
